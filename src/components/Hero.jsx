            ...
            <div className='w-full p-8 md:w-1/2'>
                <div className='mb-4 flex space-x-2'>
                    ...
                    <motion.img
                        ...
                        src={profileImg2} alt="Team Member 2" className='h-12 w-12 rounded-full border-2 border-orange-50' />
                    <motion.img
                        initial={{ opacity: 0, scale: 0.8 }}
                        animate={{ opacity: 1, scale: 1 }}
                        transition={{ duration: 0.8, delay: 0.3 }}
                        src={profileImg3} alt="Team Member 3" className='h-12 w-12 rounded-full border-2 border-orange-50' />
                </div>
                <motion.h1
