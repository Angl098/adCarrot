                ...
                <div className='container mx-auto px-4'>
                    <div className='flex h-16 items-center justify-between'>
                        <div className='flex items-center'>
                            <a href="/">
                                <img src={logo} alt="ad-landing" width={120} height={20} />
                            </a>
                        </div>
                        <div>
                    ...
                    <motion.div
                        ...
                        {LINKS.map((link, index) => (
                            <motion.a
                                ...
                                key={index} href={`#${link.id}`} onClick={(e) =>
                                    handleLinkClick(e, link.id)} className='transition-colors duration-500 hover:text-orange-500'>
                                {link.name}
                            </motion.a>
                        ))}
                    </motion.div>
