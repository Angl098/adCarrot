    ...
    return (
        <section className='bg-stone-50 p-4' id='contact'>
            ...
            <form onSubmit={handleSubmit} className='mx-auto mb-20 lg:max-w-3xl'>
                ...
                <button type='submit' className={`mb-8 w-full rounded border bg-emerald-950 px-4 py-2 text-sm font-semibold text-orange-50 hover:bg-emerald-900 ${isSending ? "cursor-not-allowed opacity-50" : ""}`} disabled={isSending}>
